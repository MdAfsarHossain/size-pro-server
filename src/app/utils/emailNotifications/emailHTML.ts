...
<head>
    ...
    <title>AJPropl Email Verification</title>
    <style>
            ...
            <td style="padding: 20px 0;">
                <div class="email-container">
                    ...
                    <div class="email-content">
                        ...
                        <p class="main-text">
                            Thank you for choosing <span class="brand-highlight">AJ-Propl</span>. Use this OTP to
                            complete your Sign Up procedures and verify your account on <span
                                class="brand-highlight">AJ-Propl</span>.
                        </p>

                        <p class="warning-text">
                            Remember, Never share this OTP with anyone, not even if <span
                                class="brand-highlight">AJ-Propl</span> ask to you.
                        </p>
                    ...
                    <div class="social-section">
                        ...
                        <div class="email-signature">
                            ...
                            <p class="team-name">Team <span class="brand-highlight">AJ-Propl</span>.</p>
                        </div>
                    </div>
                </div>
            </td>
