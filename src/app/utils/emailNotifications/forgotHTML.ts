export const forgotEmailTemplate = (otp: string) => `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
...
<p style="margin:0;">Welcome to <strong style="color:#2c3e50;">AJPropl</strong>.  

              We received a request to reset the password for your account on AJPropl. Use this OTP to complete the password reset process.</p>
</td>
</tr>
...
<td style="padding:20px 40px 30px 40px; font-size:13px; color:#7f8c8d; line-height:1.5; text-align:center;">
              ...
              ⚠️ Keep this code private. AJPropl will never request it from you.
</td>
</tr>
...
<p style="margin:0; font-size:13px; color:#7f8c8d;">Team AJPropl</p>
</td>
</tr>
