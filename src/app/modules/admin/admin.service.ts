...
//         typeof document.imageDetails === "string"
//           ? JSON.parse(document.imageDetails)
//           : document.imageDetails || {}; // Add fallback empty object

//       // Extract product_title and category from the nested structure with null checks
//       const product_title =
//         imageDetails?.product_title ||
...
//       // Safely check array lengths with optional chaining and null checks
...
//     finalResult = finalResult.filter((doc) => {
//       // Add null check for product_title before calling toLowerCase()
...
//   // Recalculate total after filtering if search was applied
//   const filteredTotal = search ? finalResult.length : total;
...
//       limit: limitNumber,
//       total: filteredTotal,
//       hasNextPage: pageNumber < Math.ceil(filteredTotal / limitNumber),
//       hasPrevPage: pageNumber > 1,
//       totalPage: Math.ceil(filteredTotal / limitNumber),
//     },
//   };
// };
